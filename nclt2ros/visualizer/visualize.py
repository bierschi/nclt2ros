...
class Visualize:
    ...
    """
    def __init__(self, date, show_plot, **kwargs):
        ...
        if isinstance(show_plot, bool):
            ...
            raise TypeError('show plot must be type of boolean')
        ...
        if self.v_gt_kml:
            ...
            self.gt = GroundTruth(date=self.date, plt_show=show_plot)
        ...
        if self.v_gps_kml:
            ...
            self.gps = GPS(date=self.date, plt_show=show_plot)
        ...
        if self.v_gps_rtk_kml:
            ...
            self.gps_rtk = GPS_RTK(date=self.date, plt_show=show_plot)
        ...
        if self.v_odom_kml:
            ...
            self.wheel_odom = WheelOdom(date=self.date, plt_show=show_plot)
        ...
        if self.v_all:
            ...
            self.all = AllSensors(date=self.date, plt_show=show_plot)
            self.all.plot()
